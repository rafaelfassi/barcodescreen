...
public slots:
    ...
    /**
      * The decoding function accessible from QML (Does not work in QtQuick)
      */
    QString decodeImageQML(QObject *item);

    /**
      * The decoding function accessible from QML. Able to set the decoding
      * of a portion of the image. (Does not work in QtQuick)
      */
    ...
    /**
      * The decoding function accessible from QML (Source from QQuickImageProvider)
      */
    QString decodeImageSource(QString source);
